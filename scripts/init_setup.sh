...
cp -f "$dotfiles/.mise.tmpl.toml" "$HOME/.mise.toml"
...
ln -sfnv "$dotfiles_config/mise/.default-go-packages" "$HOME/.default-go-packages"
ln -sfnv "$dotfiles_config/mise/.default-npm-packages" "$HOME/.default-npm-packages"
ln -sfnv "$dotfiles_config/mise/.default-python-packages" "$HOME/.default-python-packages"
