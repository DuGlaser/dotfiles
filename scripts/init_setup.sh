...
cp -f "$dotfiles/.rtx.tmpl.toml" "$HOME/.rtx.toml"
...
ln -sfnv "$dotfiles_config/rtx/.default-go-packages" "$HOME/.default-go-packages"
ln -sfnv "$dotfiles_config/rtx/.default-npm-packages" "$HOME/.default-npm-packages"
ln -sfnv "$dotfiles_config/rtx/.default-python-packages" "$HOME/.default-python-packages"
